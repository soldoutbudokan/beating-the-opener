...
> `status=settled` (2W-3L, bankroll $98.91 of $100), and `live/picks.csv` was
> empty. Nothing needs unwinding. If that is ever untrue at pause time,
> settle open bets manually before halting.
>
